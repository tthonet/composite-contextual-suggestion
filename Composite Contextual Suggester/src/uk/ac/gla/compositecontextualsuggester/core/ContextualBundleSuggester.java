...
import uk.ac.gla.compositecontextualsuggester.util.CategoryHandler;
import uk.ac.gla.compositecontextualsuggester.util.LocatedIdHandler;
import uk.ac.gla.compositecontextualsuggester.util.Location;
import uk.ac.gla.compositecontextualsuggester.util.LocationHandler;
import uk.ac.gla.compositecontextualsuggester.util.User;
import uk.ac.gla.compositecontextualsuggester.util.UserHandler;
import uk.ac.gla.compositecontextualsuggester.util.Venue;
import uk.ac.gla.compositecontextualsuggester.util.VenueHandler;
